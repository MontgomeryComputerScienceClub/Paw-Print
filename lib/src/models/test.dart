...
Map<String, dynamic> pawprintex = {
  "id": 100,
  "title": "2024 Oscar Nominations: Recap",
  "content":
...
Story defaultStory = Story.fromJson(storyJson2);
Story defaultStory2 = Story.fromJson(pawprintex);

StoryPreview previewStory = StoryPreview.fromJson(storyJson2);
StoryPreview previewStory2 = StoryPreview.fromJson(pawprintex);
